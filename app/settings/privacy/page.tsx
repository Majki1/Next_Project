...
const Settings = () => {
    ...
    const items = [
        ...
        { title: 'Privacy and Security', href: '/settings/privacy' },
    ].map((item, index) => (
...
<>
  ...
  <div className='h-screen flex justify-center items-center w-full'>
    <div className='flex justify-center mt-[-25%] ml-[-30%] w-full text-white'>
      <Tabs orientation="vertical" classNames={{tab: 'text-large hover:bg-neutral-800 hover:text-cyan-500', panel: 'w-full', root: 'ml-[20%] w-[70%]'}} value='privacy' onChange={(value) => router.push(`/settings/${value}`)}>
        <Tabs.List>
        ...
        <Tabs.Panel value="privacy" className='ml-[20%]'>Privacy conent</Tabs.Panel>
      </Tabs>
    </div>
  </div>
</>
